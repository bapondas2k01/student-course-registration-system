...
public class SignupController implements Initializable {
    ...
    private void Signup(ActionEvent event) throws IOException {
        ...
        if (fullname.isEmpty() || id.isEmpty() || dept.isEmpty() || email.isEmpty() || contact.isEmpty() || password.isEmpty() || confirmPassword.isEmpty()) {
        ...
        try (Connection conn = ConnectionDB.getConnection()) {
            ...
            if (rs.getInt(1) > 0) {
                ...
                String sql = "INSERT INTO students (name, id, phone, password, dept, email) VALUES (?, ?, ?, ?, ?, ?)";
